...
enum GOControllerType
{
    ...
    GO_AI 		 = 0x04, // 0000100 => Ai Player (= CT_CPU)
...
public :
    ...
    static const StringHash GLOVES;
    static const StringHash BOOTS;
...
const StringHash CMAP_GLOVES = StringHash("Gloves");
const StringHash CMAP_BOOTS = StringHash("Boots");
...
const StringHash CMAP_NOGLOVES = StringHash("No_Gloves");
const StringHash CMAP_NOBOOTS = StringHash("No_Boots");
