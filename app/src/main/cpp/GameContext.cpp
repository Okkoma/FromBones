...
{
    { SCANCODE_W, SCANCODE_S, SCANCODE_A, SCANCODE_D, SCANCODE_SPACE, SCANCODE_E, SCANCODE_F, SCANCODE_R,
        SCANCODE_E, SCANCODE_Q, SCANCODE_TAB, SCANCODE_TAB, SCANCODE_TAB, SCANCODE_TAB },
    { SCANCODE_UP, SCANCODE_DOWN, SCANCODE_LEFT, SCANCODE_RIGHT, SCANCODE_RCTRL, SCANCODE_RSHIFT, SCANCODE_SLASH, SCANCODE_PERIOD,
        SCANCODE_RSHIFT, SCANCODE_BACKSLASH, SCANCODE_APOSTROPHE, SCANCODE_APOSTROPHE, SCANCODE_APOSTROPHE, SCANCODE_APOSTROPHE },
    { SCANCODE_W, SCANCODE_S, SCANCODE_A, SCANCODE_D, SCANCODE_SPACE, SCANCODE_E, SCANCODE_F, SCANCODE_R,
        SCANCODE_E, SCANCODE_Q, SCANCODE_TAB, SCANCODE_TAB, SCANCODE_TAB, SCANCODE_TAB },
    { SCANCODE_UP, SCANCODE_DOWN, SCANCODE_LEFT, SCANCODE_RIGHT, SCANCODE_RCTRL, SCANCODE_RSHIFT, SCANCODE_SLASH, SCANCODE_PERIOD,
        SCANCODE_RSHIFT, SCANCODE_BACKSLASH, SCANCODE_APOSTROPHE, SCANCODE_APOSTROPHE, SCANCODE_APOSTROPHE, SCANCODE_APOSTROPHE }
...
{
    { SDL_CONTROLLER_BUTTON_DPAD_UP, SDL_CONTROLLER_BUTTON_DPAD_DOWN, SDL_CONTROLLER_BUTTON_DPAD_LEFT, SDL_CONTROLLER_BUTTON_DPAD_RIGHT, SDL_CONTROLLER_BUTTON_A, SDL_CONTROLLER_BUTTON_B, SDL_CONTROLLER_BUTTON_X, SDL_CONTROLLER_BUTTON_Y,
        SDL_CONTROLLER_BUTTON_B, SDL_CONTROLLER_BUTTON_START, SDL_CONTROLLER_BUTTON_LEFTSHOULDER, SDL_CONTROLLER_BUTTON_RIGHTSHOULDER, SDL_CONTROLLER_BUTTON_LEFTSHOULDER, SDL_CONTROLLER_BUTTON_RIGHTSHOULDER  },
    { SDL_CONTROLLER_BUTTON_DPAD_UP, SDL_CONTROLLER_BUTTON_DPAD_DOWN, SDL_CONTROLLER_BUTTON_DPAD_LEFT, SDL_CONTROLLER_BUTTON_DPAD_RIGHT, SDL_CONTROLLER_BUTTON_A, SDL_CONTROLLER_BUTTON_B, SDL_CONTROLLER_BUTTON_X, SDL_CONTROLLER_BUTTON_Y,
        SDL_CONTROLLER_BUTTON_B, SDL_CONTROLLER_BUTTON_START, SDL_CONTROLLER_BUTTON_LEFTSHOULDER, SDL_CONTROLLER_BUTTON_RIGHTSHOULDER, SDL_CONTROLLER_BUTTON_LEFTSHOULDER, SDL_CONTROLLER_BUTTON_RIGHTSHOULDER  },
    { SDL_CONTROLLER_BUTTON_DPAD_UP, SDL_CONTROLLER_BUTTON_DPAD_DOWN, SDL_CONTROLLER_BUTTON_DPAD_LEFT, SDL_CONTROLLER_BUTTON_DPAD_RIGHT, SDL_CONTROLLER_BUTTON_A, SDL_CONTROLLER_BUTTON_B, SDL_CONTROLLER_BUTTON_X, SDL_CONTROLLER_BUTTON_Y,
        SDL_CONTROLLER_BUTTON_B, SDL_CONTROLLER_BUTTON_START, SDL_CONTROLLER_BUTTON_LEFTSHOULDER, SDL_CONTROLLER_BUTTON_RIGHTSHOULDER, SDL_CONTROLLER_BUTTON_LEFTSHOULDER, SDL_CONTROLLER_BUTTON_RIGHTSHOULDER  },
...
void GameContext::PreselectBestControllers()
{
    ...
    if (gameConfig_.touchEnabled_ || gameConfig_.forceTouch_)
    {
        ...
        playerState_[1].controltype = CT_JOYSTICK;
        playerState_[2].controltype = CT_JOYSTICK;
        playerState_[3].controltype = CT_JOYSTICK;
    }
    // desktop devices
    else
    {
        ...
        if (playerState_[0].controltype == CT_KEYBOARD)
            numkeyconfigs--;
        playerState_[1].controltype = numjoysticks > 1 ? CT_JOYSTICK : CT_KEYBOARD;
        if (playerState_[1].controltype == CT_KEYBOARD)
            numkeyconfigs--;
        playerState_[2].controltype = numjoysticks > 2 ? CT_JOYSTICK : CT_KEYBOARD;
        if (playerState_[2].controltype == CT_KEYBOARD)
            numkeyconfigs--;
        playerState_[3].controltype = numjoysticks > 3 ? CT_JOYSTICK : CT_KEYBOARD;
    }
}
