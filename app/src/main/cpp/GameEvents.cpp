...
void GOE::InitEventTable()
{
    ...
    events_ += Pair<StringHash,String>(StringHash("Game_ScreenResized"), "Game_ScreenResized");
    events_ += Pair<StringHash,String>(StringHash("Game_RemoveScene"), "Game_RemoveScene");
    events_ += Pair<StringHash,String>(StringHash("Game_PreloadingFinished"), "Game_PreloadingFinished");
    ...
    events_ += Pair<StringHash,String>(StringHash("TextMessage_Clean"), "TextMessage_Clean");
    events_ += Pair<StringHash,String>(StringHash("Object_SelfDestroy"), "Object_SelfDestroy");

    events_ += Pair<StringHash,String>(StringHash("Game_OptionsFrameClosed"), "Game_OptionsFrameClosed");

    events_ += Pair<StringHash,String>(StringHash("Go_Selected"), "Go_Selected");
    events_ += Pair<StringHash,String>(StringHash("Go_TrigClicked"), "Go_TrigClicked");

    events_ += Pair<StringHash,String>(StringHash("World_Dirty"), "World_Dirty");
    events_ += Pair<StringHash,String>(StringHash("World_FinishLoading"), "World_FinishLoading");
...
//    events_ += Pair<StringHash,String>(StringHash("Go_DirectionChanged"), "Go_DirectionChanged");
    ...
    events_ += Pair<StringHash,String>(StringHash("ControlActionStop"), "ControlActionStop");
    ...
    events_ += Pair<StringHash,String>(StringHash("MapTileRemoved"), "MapTileRemoved");

    events_ += Pair<StringHash,String>(StringHash("Go_ChangeDirection"), "Go_ChangeDirection");
    events_ += Pair<StringHash,String>(StringHash("Go_UpdateDirection"), "Go_UpdateDirection");
    ...
    events_ += Pair<StringHash,String>(StringHash("Go_NodesChanged"), "Go_NodesChanged");
    ...
    events_ += Pair<StringHash,String>(StringHash("Ai_ChangeOrder"), "Ai_ChangeOrder");
    events_ += Pair<StringHash,String>(StringHash("Dialog_Detected"), "Dialog_Detected");
    events_ += Pair<StringHash,String>(StringHash("Dialog_Open"), "Dialog_Open");
    events_ += Pair<StringHash,String>(StringHash("Dialog_Close"), "Dialog_Close");
    events_ += Pair<StringHash,String>(StringHash("Ability_Release"), "Ability_Release");

    events_ += Pair<StringHash,String>(StringHash("Event_Default_Ground"), "Event_Default_Ground");
    events_ += Pair<StringHash,String>(StringHash("Event_Default_Climb"), "Event_Default_Climb");
    events_ += Pair<StringHash,String>(StringHash("Event_Default_Air"), "Event_Default_Air");
    events_ += Pair<StringHash,String>(StringHash("Event_Default_Fluid"), "Event_Default_Fluid");
    ...
    events_ += Pair<StringHash,String>(StringHash("Event_OnWalk"), "Event_OnWalk");
    events_ += Pair<StringHash,String>(StringHash("Event_OnFall"), "Event_OnFall");
    events_ += Pair<StringHash,String>(StringHash("Event_OnFlyUp"), "Event_OnFlyUp");
    events_ += Pair<StringHash,String>(StringHash("Event_OnFlyDown"), "Event_OnFlyDown");
    events_ += Pair<StringHash,String>(StringHash("Event_OnClimb"), "Event_OnClimb");
    events_ += Pair<StringHash,String>(StringHash("Event_OnSwim"), "Event_OnSwim");
    events_ += Pair<StringHash,String>(StringHash("Event_ChangeArea"), "Event_ChangeArea");
    events_ += Pair<StringHash,String>(StringHash("Event_ChangeGravity"), "Event_ChangeGravity");
    ...
    events_ += Pair<StringHash,String>(StringHash("SPRITER_Sound"), "SPRITER_Sound");
