...
void RGBAtoHSV(ANLV1_SRGBA &col, ANLV1_SRGBA &hsv)
{
    float mn,mx,dlt;
    float h,s,v;
...
void HSVtoRGBA(ANLV1_SRGBA &hsv, ANLV1_SRGBA &col)
{
    /*
    hsv[0]=hsv[0]*360.0f;
