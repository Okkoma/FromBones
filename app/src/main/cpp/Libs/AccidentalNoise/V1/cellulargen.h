...
public:
    ...
    SCellularCache &get(float x, float y);
    SCellularCache &get(float x, float y, float z);
    SCellularCache &get(float x, float y, float z, float w);
    SCellularCache &get(float x, float y, float z, float w, float u, float v);
