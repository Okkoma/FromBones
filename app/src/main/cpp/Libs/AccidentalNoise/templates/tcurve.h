...
public:
    ...
    void pushPoint(float t, T point)
    {
    ...
    T linearInterp(float t)
    {
        ...
        float t0=(*prev_iter).m_t;
        float t1=(*iter).m_t;
        float interp=(t-t0)/(t1-t0);
...
protected:
    ...
    tIterType findControlPoint(float t)
    {
