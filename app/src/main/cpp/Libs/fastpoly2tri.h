...
const unsigned MPE_MAX_FLIPPINGEDGE = 16;
static int flipEdgeCount = 0;
...
{
//    if (!ValidateFlipEdgeRecurrence(EdgeP, EdgeQ,/* EdgeQIndex,*/ Triangle, Point, PointIndex))
//        return;
    ...
    {
        // MPE_BREAK;
        /// TEST 13/01/2023 - FROMBONES : break here when to much recurrence !
//        flipEdgeCount++;
//        if (flipEdgeCount > MPE_MAX_FLIPPINGEDGE)
//        {
//            return;
//        }
                         ...
                         MPEPolyTriangle* Triangle, MPEPolyPoint* Point, i32 PointIndex)
{
    ...
    if (Triangle->Points[PointIndex] != Point)
    {
        return;
    }
...
#define MPE_INITIAL_TRIANGLE_FACTOR  (poly_float)0.3f
    ...
    //NOTE: Finalize polygon
    {
        ...
        while (Triangle && !MPE_GetConstrainedEdgeCW(Triangle, Point))
        {
