...
#include "Editor/EditorParticleEffect.as"
...
#include "Editor/EditorExport.as"
#include "Editor/EditorResourceBrowser.as"
#include "Editor/EditorSpawn.as"
#include "Editor/EditorSoundType.as"
*/
#include "Editor/EditorLayers.as"
//#include "Editor/EditorColorWheel.as"

#include "Editor/EditorEventsHandlers.as"
//#include "Editor/EditorViewDebugIcons.as"
...
void Start()
{
    ...
    configFileName = fileSystem.GetAppPreferencesDir("OkkoStudio", "FromBones") + "/Editor/Config.xml";
...
//    engine.autoExit = false;
    ...
    if (input.inputScale != Vector2::ONE)
    {
        ...
        Texture2D@ uiTex = cache.GetResource("Texture2D", "Textures/UI/UI.png");
        if (uiTex !is null)
